<?php 
  ...
  if (!empty($_POST['inputName']) && !empty($_POST['inputFirstName']) && !empty($_POST['inputDateOfBirth']) && !empty($_POST['inputNationality']  )  && !empty($_POST['inputAddress'])  && !empty($_POST['inputZip'])  && !empty($_POST['inputCity'])  && !empty($_POST['inputPhone'])  && !empty  ($_POST['inputEmail'])  && !empty($_POST['inputIDPoleEmploi'])  && !empty($_POST['inputDiplome']) && !empty($_POST['inputBadge'])  &&! empty($_POST['inputSuperHero']) && !empty  ($_POST['inputHack']) && !empty($_POST['inputXP'])) {
    
    if ($_SERVER["REQUEST_METHOD"] == "POST") {

      // Name
      if (empty($_POST["inputName"])) {
        $inputnameErr = "Champs requis";
      } else {
        $inputName = ($_POST["inputName"]);
          if (!preg_match("/^[a-zA-Z-' ]*$/",$inputName)) {
            $inputnameErr = "Seules les lettres et les espaces sont autorisés";
          } else {
            echo "Validé"
          }
        }
      ...
      // Date de naissance
      if (empty($_POST["inputDateOfBirth"])) {
        $inputDateOfBirthErr = "Champs requis";
      } else { 
        $inputDateOfBirth = ($_POST["inputDateOfBirth"]);
          if (!preg_match("/^([0-2][0-9]|(3)[0-1])(\/)(((0)[0-9])|((1)[0-2]))(\/)\d{4}$/",$inputDateOfBirth)) {
            $inputDateOfBirthErr = "Seules les chiffres sont autorisés";
          }
        }
      ...
      if (empty($_POST["inputPhone"])) {
        ...
        $inputPhone = ($_POST["inputPhone"]);
          if (!preg_match("/^([A-Z][a-z.-])+$/",$inputPhone)) {
...
<h1 class="text-center">Inscription</h1>
  ...
  <div class="row ">
      ...
      <div class="form-inline col-md-2">
        ...
        <input type="text" class="form-control" name="inputDateOfBirth" placeholder="01/01/1994">
      </div>
      ...
      <div class="form-group col-md-3">
        ...
        <input type="text" class="form-control" name="inputNationality" placeholder="Française">
      </div>
      </div>
      <div class="row">
      ...
      <div class="form-group col-md-3">
        ...
        <input type="email" class="form-control" name="inputEmail" placeholder="jojo@hotmail.fr">
      </div>
      <div class="form-group col-md-3">
          <label for="inputIDPoleEmploi">Numéro Pôle Emploi</label>
          <input type="text" class="form-control" name="inputIDPoleEmploi">
        </div>
        </div>
      <div class="row">
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-8">
          ...
          <input type="text" class="form-control" name="inputXP">
        </div>
      </div>
