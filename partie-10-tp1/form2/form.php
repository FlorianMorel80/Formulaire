  ...
  <div class="row">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-8">
          ...
          <input type="text" class="form-control" name="inputHack" pattern="([A-Za-z.- ])+" title ="Le champs ne doit comporter que des lettres">
        </div>
        <div class="form-group col-md-8">
          ...
          <input type="text" class="form-control" name="inputXP" pattern="([A-Za-z.- ])+" title ="Le champs ne doit comporter que des lettres">
        </div>
      </div> -->
