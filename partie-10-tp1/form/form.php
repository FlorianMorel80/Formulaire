...
<h2 class="text-center text-light pt-2"> Vous aussi créez le formulaire de vos rêves</h2>
  ...
  <div class="row">
      ...
      <div class="form-group col-md-5">
        ...
        <input type="email" class="form-control" value="<?= isset($_POST['inputEmail']) ? $_POST['inputEmail'] : '' ?>" name="inputEmail" pattern="[A-Za-z0-9.@_!#$%&’`*?^+{|}~-]+@[a-z0-9]+\.[a-z]{2,6}" title ="Format de l'email invalide" placeholder="jojo@hotmail.fr">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-6">
          ...
          <input type="text"  class="form-control" value="<?= isset($_POST['inputURL']) ? $_POST['inputURL'] : '' ?>" name="inputURL" pattern="(?:http(s)?://)?[\w.-]+(?:.[\w.-]+)+[\w-._~:/?#[]@!$&'()*+,;=.]+" title ="">
        ...
        <div class="form-group col-md-12">
          ...
          <textarea type="text" rows="6" class="form-control" value="<?= isset($_POST['inputSuperHero']) ? $_POST['inputSuperHero'] : '' ?>" name="inputSuperHero"></textarea>
